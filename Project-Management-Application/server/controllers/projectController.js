...
export const createProject = async (req , res) => {
    try {
        ...
        const {workspaceId, description, name, status, start_date, end_date, team_members, team_lead,
...
export const updateProject = async (req , res) => {
    try {
        const {userId} = await req.auth();
        const {id,workspaceId, description, name, status, start_date, end_date, team_members, team_lead,
            progress, priority} = req.body;
